...
namespace Cadar_Raul_Lab2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["CustomerID"] = new SelectList(_context.Customer, "Name", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderID,CustomerID,BookID,OrderDate")] Order order)
        {
            ...
            ViewData["BookID"] = new SelectList(_context.Book, "Title", "Title", order.BookID);
            ViewData["CustomerID"] = new SelectList(_context.Customer, "Name", "Name", order.CustomerID);
            return View(order);
        }
