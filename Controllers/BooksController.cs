...
using Cadar_Raul_Lab2.Data;
using Cadar_Raul_Lab2.Models;

namespace Cadar_Raul_Lab2.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var book = await _context.Book
                ...
                .Include(s => s.Orders).ThenInclude(e => e.Customer).AsNoTracking()
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            ViewData["AuthorID"] = new SelectList(_context.Set<Author>(), "ID", "ID", bookToUpdate.AuthorID);
            ViewData["GenreID"] = new SelectList(_context.Set<Genre>(), "ID", "ID", bookToUpdate.GenreID);
